...
| 6 | **Bloodwork uploads** (photo/PDF/manual metadata + extracted values) | `bloodwork_uploads` | Life of account | +30d → `bloodworkUploads.deleteMany` | **OPEN: original uploaded files** (when real storage exists) must also be user-deletable + erased — not yet covered (`MOCKED_APIS.md` §17) |
